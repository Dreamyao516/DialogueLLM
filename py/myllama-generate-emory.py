...
def generate_test_prompt(data_point):
    ...
    if data_point["input"]:
        ...
        if "Context" not in data_point:
            ...
            ### Sample:[
            Instruction:Yeah, right!.......Y'serious?
            Input:Neutral
            Instruction:No, it's good, it is good, it's just that- mm- doesn't she seem a little angry?
            Input:Fear
            Instruction:Everything you need to know is in that first kiss.
            Input:Powerful
            Instruction:Yeah, well, word of advice: Bring back the comedian. Otherwise next time you're gonna find yourself sitting at home, listening to that album alone.
            Input:Sadness
            Instruction:Well... you never know. How's, um.. how's the family?
            Input:Peaceful
            Instruction:What you guys don't understand is, for us, kissing is as important as any part of it.
            Input:Joy
            Instruction:The problem is, though, after the concert's over, no matter how great the show was, you girls are always looking for the comedian again, y'know? I mean, we're in the car, we're fighting traffic... basically just trying to stay awake.
            Input:Anger
            ]
...
def post_process(task, response: str):
    ...
    labels_dict = {"sentiment": ["positive", "neutral", "negative", "pos", "neg", "neu", "0", "1"],
                   "emotion": ["happy", "happiness", "joy", "fear", "scare", "sad", "sadness", "disgust", "disgusting",
                               ...
                               "amazing", "0", "peaceful", "6", "powerful", "5", "4", "3", "2", "1"],
    ...
    synonymy_dict = {"sentiment": {("positive", "pos", "1"): 1, ("neutral", "neu"): 0, ("negative", "neg", "0"): 2},
                     "emotion": {("happy", "happiness", "joy", "glad", "1"): 1, ("neutral", "neu", "0"): 0,
                                 ("sad", "sadness", "2"): 2, ("anger", "angry", "rage", "3"): 3,
                                 ("fear", "scare", "4"): 4,
                                 ("powerful", "5"): 5,
                                 ("peaceful", "6"): 6},
...
def main():
    try:
        ...
        # 0----首先设置测试集路径 和 任务
        TEST_SET = "./test_dataset/emorynlp_test.json"
        TASK = "emotion"
        outputdir = "./shot_result/emorynlp_1_shot.csv"
        #BASE_MODEL = "decapoda-research/llama-7b-hf"
        BASE_MODEL = "meta-llama/Llama-2-7b-hf"
        LORA_MODEL = "./End/lama2_emorynlp_loss10"
