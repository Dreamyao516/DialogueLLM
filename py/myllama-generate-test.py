...
def post_process(task, response: str):
    ...
    labels_dict = {"sentiment": ["positive", "neutral", "negative", "pos", "neg", "neu", "0", "1"],
                    "emotion": ["happy", "happiness", "joy", "fear", "scare", "sad", "sadness", "disgust", "disgusting", "hate", "surprise", "anger", "angry", "rage", "neutral", "amazed", "surprising","amazing","0"],
    ...
    synonymy_dict = {"sentiment": { ("positive", "pos", "1") : 1, ("neutral", "neu") : 0, ("negative", "neg", "0") : 2 },
                     "emotion": { ("happy", "happiness", "joy", "glad") : 1, ("neutral", "neu", "0") : 0,  ("sad", "sadness") : 2,  ("anger", "angry", "rage") : 3,  ("fear", "scare") : 4,  ("disgust", "disgusting", "hate") : 5, ("surprise", "amazing", "amazed", "surprising") : 6} ,
